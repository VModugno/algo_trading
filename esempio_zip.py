# -*- coding: utf-8 -*-
"""
Created on Fri Jun  5 19:41:17 2020
...
datas = OrderedDict()
datas['SPY'] = pd.read_csv('C:\\Users\\alfre\\script_zipline\\data.csv', index_col=0, parse_dates=['Date'])
...
def handle_data(context, panel):
    ...
    print('ciao')
    print(panel)
    print(dir(context.security))
    print(context.security.start_date)
    print(panel[context.security])
    print(panel.history(context.security,'price',100, '1d'))
