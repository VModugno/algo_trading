...
def get_benchmark_returns(symbol):
    ...
    IEX_CLOUD_API_TOKEN = IEX_CLOUD_API_TOKEN.strip("'")
    ...
    print("https://cloud.iexapis.com/stable/stock/{}/chart/5y?chartCloseOnly=True&token={}".format(symbol, IEX_CLOUD_API_TOKEN))
    data = r.json()
